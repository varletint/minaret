import { Radio, Twitter, Mail } from "lucide-react";
...
export function Footer() {
  ...
  const socialLinks = [
    ...
    { name: "Email", href: "istherethunder@gmial.com", icon: Mail },
  ];
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8'>
          ...
          <div className='lg:col-span-2'>
            ...
            <p className='text-sm text-muted-foreground max-w-xs mb-4'>
              Your mosque community hub. Listen to live lectures, prayers, find
              mosques, and connect with your community.
            </p>
            {/* Social Links */}
          ...
          {/* Product Links */}
          <div>
            <h3 className='font-heading font-semibold mb-2'>Product</h3>
          ...
          {/* Company Links */}
          <div>
            <h3 className='font-heading font-semibold mb-2'>Company</h3>
            <ul className='space-y-0'>
